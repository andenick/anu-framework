...
# See <internal-tool>/docs/ANU_REBUILD_LESSONS_v1.md for context.
...
# See <internal-tool>/docs/RMWND_HYPER_REVIEW_2026-05-19.md
#     <internal-tool>/docs/RSCD_HYPER_REVIEW_2026-05-19.md
#     <internal-tool>/docs/decisions/0001-0006.md
...
def _find_project_inputs_robin(project: Path) -> Path | None:
    ...
    # check_project.py is at <workspace>/<internal-tool>/.claude/skills/anu-doctor/
