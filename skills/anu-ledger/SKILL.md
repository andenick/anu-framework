...
**Example (from the reference implementation — adapt values for your project):**
...
"distribution": {
  ...
  "drive":    {"version": "1.3",   "shipped": "2026-05-14", "package": "my-replication_Drive_v1.3"},
  "archive":  {"version": "1.0",   "shipped": "2026-05-14", "package": "my-replication_Archive_v1.0"}
}
```
