...
When creating research files for many series in a chapter simultaneously, a streamlined entry format is acceptable. **Example (reference implementation, S034):**
