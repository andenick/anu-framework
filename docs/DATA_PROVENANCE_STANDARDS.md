...
- **Naming.** `S###_DPR.md`, `S###_EPR.md`, `Fig{N.M}_FPR.md`. Examples (from the reference implementation): `S001_DPR.md`, `S038_EPR.md`, `Fig10.1_FPR.md`.
...
### Worked example (compressed from `<project>/Technical/docs/series/S001_DPR.md`)
...
### No-Extension EPR worked example (compressed from `<project>/Technical/docs/series/S038_EPR.md`)
...
### Worked example (compressed from `<project>/Technical/docs/figures/Fig10.1_FPR.md`)
