...
These constraints were formalized from lessons learned in the CD2 Shaikh (2016) replication, where 21% of initial extensions used wrong-concept proxies that were caught only in post-hoc audit. See `<project>/Technical/docs/SKEPTICAL_EXTENSION_REVIEW.md` for the full case study.
