...
- **CD2** (`<project>/`) is designated the framework's reference implementation — the most complete Anu Framework project and the known-good example for new projects to copy. It exercises all 18 skills and all three distribution channels.
